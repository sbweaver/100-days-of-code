...
**Today's Progress**: Working in a bunch of different WP themes - comparing things - looking at builders too for their speed but don't really want to use them... 

**Thoughts**: Overwhelmed by options... tomorrow's another day

**Link(s) to work**: 


### Day 25: January 27, 2018 

**Today's Progress**: Listened to The Big Web Show with Zeldman and Jen Simmons  - listened to Jen's first Layout Land video on YouTube explaining explicit vs. implicit CSS grid layout; Working on my underscores theme. 
...
**Today's Progress**: played with CSS animation on Codepen
...
### Day 58: March 24, 2018 

**Today's Progress**: Back to Underscores theme. I installed Gutenberg plugin - going to see what I can do with that. 
...
### Day 65: April 15, 2018 

**Today's Progress**: Playing with grid. Trying to see how I could automate the content coming in using different selectors. Got a page looking decent. 
...
### Day 08: January 10, 2019 

**Today's Progress**: WP Rig tutorial - Customizing templates and moving things around. 
